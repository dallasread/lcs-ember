...
* infinate scroll for visitors

* Setup process/admin login.
* Online/offline toggle
* Disconnect should go offline
...
* switch visitor agent when new agent responds
...
* load ember and style on the fly
